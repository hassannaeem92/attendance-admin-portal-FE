...
@Component({
  selector: 'app-add-edit-organization-location',
  standalone: true,
  imports: [FormsModule, MatCheckboxModule, NgIf, RouterLink, NgClass, NgSelectModule, MatDatepickerModule, MatNativeDateModule, MatFormFieldModule, MatInputModule, OrganizationModalComponent, CompanyModalComponent],

  templateUrl: './add-edit-organization-location.component.html',
  styleUrl: './add-edit-organization-location.component.scss'
})
export class AddEditOrganizationLocationComponent {
  intervalId: any
    ...
    onSubmit(NgForm: any) {
      ...
      const body = {
        ...
        IsFacial: this.model.isFacial,
        IsBiometric: this.model.isBiometric,
        IsSSN	: this.model.isSSN,
        IsLastName: this.model.isLastName
      }
      ...
      this.locationService.addLocation(body).subscribe(res => {
        if (res && res.StatusCode == 200) {
          ...
          this.router.navigate(['/main/attendance/company-location']);
