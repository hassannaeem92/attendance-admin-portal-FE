...
intervalId: any
  ...
  loadInitialData() {
    ...
    forkJoin({
      ...
      companies: this.companyService.getAllCompanysDrop(),
  ...
  onSubmit(NgForm: any) {
    const body = {
      ...
      OrganizationId: this.selectedOrganization.id ? this.selectedOrganization?.id : null,
    ...
    this.locationService.addLocation(body).subscribe(res => {
      if (res && res.StatusCode == 200) {
        ...
        this.router.navigate(['/main/attendance/location/all-location']);
